...
import MetallicLogo from './components/MetallicLogo.tsx';
    ...
    return (
      <div className="fixed inset-0 z-[100] bg-[#fafafa] flex flex-col items-center justify-center">
        <div className="animate-pulse">
          <MetallicLogo size="sm" animated={true} />
        </div>
        <div className="mt-8 h-px w-24 bg-gray-200 overflow-hidden relative">
           <div className="absolute inset-0 bg-gray-800 w-full -translate-x-full animate-[slideRight_1.5s_ease-in-out_infinite]" />
        </div>
        <style>{`
    ...
    <div className="min-h-screen relative">
      ...
      <section className="py-32 bg-gray-50/50 border-t border-b border-gray-100">
        <div className="container mx-auto px-6 text-center">
          <FadeIn>
            <p className="font-cinzel text-3xl md:text-5xl text-metallic leading-tight">
              "Turning moments of decision <br /> into lasting market value."
            </p>
            <div className="mt-8 w-16 h-px bg-gray-400 mx-auto"></div>
